 ...
 * YOUR CODE BELOW *
 ******************/
let myFirstName = 'Dustin';
let myLastName = 'Hagstrom';
let myBestFriend = 'Bruce';
let mySentence = myFirstName + ' ' + myLastName + 'likes to play soccer with ' + myBestFriend;
let myFavoriteNum = 23;
let myMentalAge = 25;
let myHeight = 74;
let myFavoriteYear = 2004;
